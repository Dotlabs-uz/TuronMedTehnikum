        ...
        <>
            ...
            <main>
                <section className="section_1">
                    <div className="bg-[url('/section1/section1_bg.jpg')] bg-center h-[1000px] max-xl:h-[800px] max-lg:h-[650px] max-md:h-[550px] max-sm:h-[400px] bg-no-repeat bg-cover flex flex-col items-center pt-[300px] max-xl:pt-[200px] max-md:pt-[150px] max-sm:pt-[120px] relative">
                        <p className="text-4xl max-xl:text-3xl max-lg:text-2xl max-sm:text-xl text-white">
                            welcome to School
                        </p>
                        <h1 className="text-7xl  max-xl:text-6xl max-lg:text-5xl max-sm:text-4xl max-[400px]:text-3xl text-white text-center mt-5 max-sm:mt-2">
                            Education is the best <br /> key to success in life
                        </h1>
                        <button className="bg-white flex items-center gap-4 px-[28px] py-[16px] max-lg:px-5 max-lg:py-3 max-sm:px-2 max-sm:py-1 text-[#032D6C] text-[18px] max-sm:text-base max-[400px]:text-sm font-medium rounded-md mt-10  max-sm:mt-10">
                            UPCOMING NOTICE
                            <BiChevronRight size={30} color={"#032D6C"} />
                        </button>

                        <div className="flex items-center justify-between gap-10 absolute -bottom-[100px] max-lg:hidden">
                ...
                <section className="section_4 mt-14 max-lg:mt-10">
                    ...
                    <div className="mt-20 max-xl:mt-16 max-lg:mt-10 h-[700px] max-xl:h-[550xp] max-lg:h-[450px] max-md:h-[350px] max-sm:h-[250px] max-[400px]:h-[200px] bg-[url('/section4/section4.jpg')] bg-cover bg-no-repeat bg-center"></div>
                </section>
                ...
                <section className="section_7 mt-20 max-xl:mt-10">
                    <div className="custom_container">
                        ...
                        <div className="mt-10 max-md:mt-5 grid grid-cols-4 auto-rows-[180px] max-xl:auto-rows-[160px] max-lg:auto-rows-[140px] max-md:auto-rows-[100px] max-sm:auto-rows-[70px]  max-[400px]:auto-rows-[60px] gap-5 max-md:gap-2">
                            <div className="bg-[royalblue] col-start-1 col-end-2 row-start-1 row-end-3">
                                1
                            </div>
                            <div className="bg-[#8941e1] col-start-2 col-end-4 row-start-1 row-end-2">
                                2
                            </div>
                            <div className="bg-[#eae382] col-start-4 col-end-5 row-start-1 row-end-2">
                                3
                            </div>
                            <div className="bg-[#ea8282] col-start-1 col-end-2 row-start-3 row-end-5">
                                4
                            </div>
                            <div className="bg-[royalblue] col-start-2 col-end-4 row-start-2 row-end-5">
                                5
                            </div>
                            <div className="bg-[#8941e1] col-start-4 col-end-5 row-start-2 row-end-4">
                                6
                            </div>
                            <div className="bg-[#eae382] col-start-1 col-end-4 row-start-5 row-end-6">
                                7
                            </div>
                            <div className="bg-[#ea8282] col-start-4 col-end-5 row-start-4 row-end-6">
                                8
                            </div>
                        </div>
                    </div>
            ...
            <footer className="mt-44 max-lg:mt-32 max-md:mt-28 pt-36 bg-[#032D6C] relative">
                <div className="bg-[#E6EDF8] py-10 max-lg:py-7 max-sm:py-5 w-[900px] max-lg:w-[700px] max-md:w-[80%] max-sm:w-[90%] absolute -top-[150px] max-lg:-top-[90px] max-sm:-top-[90px] left-1/2 -translate-x-1/2 flex flex-col items-center justify-center">
                    ...
                    <form className="flex items-center gap-3 w-[70%] max-sm:w-[90%] mt-5" action="">
                        <input type="text" placeholder="Email Address" className="border font-medium border-[#032D6C] rounded-md px-5 py-3 max-sm:text-sm max-sm:px-3 max-sm:py-2 bg-[#E6EDF8] w-full" />
                        <button className="bg-[#032D6C] text-center text-[#E6EDF8] max-sm:text-sm px-5 py-3 max-sm:px-3 max-sm:py-2 rounded-md">Subscribe</button>
                    </form>
                </div>
                ...
                <p className="text-center text-white py-5 max-sm:py-2 max-sm:text-xs">copyright@school2023all right reserved</p>
            </footer>
        </>
    );
}
